...
public class UndoAwareMolecularModelManagerTest extends OWLToolsTestBasics {
    ...
    public void testUndoRedo() throws Exception {
        ...
        System.out.println("LOADED FROM MEMORY: "+g.getSourceOntology().getOntologyID());
    ...
    public void testSave() throws Exception {
        ...
        m3.saveModel(model, null, new UndoMetadata(userId));
    
        // try loading - force override in order to test fetching from blazegraph
        m3.loadModel(model.getModelId(), true);
        if (m3 != null) {
            m3.dispose();
        }
    }
