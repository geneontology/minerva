...
public class EcoMapperFactory {
     ...
     *
     * @param all             graph containing all ontologies, including ECO
     * @param reasoner        reasoner capable of traversing ECO
     * @param disposeReasoner set to true if the reasoner should be disposed, when calling
     *                        {@link TraversingEcoMapper#dispose()}
     * @return mapper
     * @throws IOException
     * @throws OWLException
     * @throws IllegalArgumentException throw when the reasoner is null, or the
